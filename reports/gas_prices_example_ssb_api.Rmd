...
##Example from <http://www.myrland.one/2016/06/07/ssbs-api-for-a-laste-ned-bensin-og-dieseldata/>

##Load packages that are going to be used:
```{r, include=FALSE}
#Try installing packages in the 'initiate-project-and-install-packages.R' file
#If using checkpoint and Markdown and you intend to install packkages anyhow, use: 
#install.packages("httr", repos = "https://mran.microsoft.com/")

#Setup package 

#Library/load packages we are going to use
...
#From example from on SSB API
#options(encoding="UTF-8")
#install.packages("pacman") # pacman: Package Management Tool
#library(pacman) # We are using an alternative, namely checkpoint
```
